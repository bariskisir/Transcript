...
export function renderCopyFeedback(refs: DomRefs, model: UiModel): void {
...
export function renderTranscript(refs: DomRefs, model: UiModel): void {
  const parts: string[] = [];
...
export function updateButtons(refs: DomRefs, model: UiModel): void {
...
function populateOptions(refs: DomRefs, model: UiModel): void {
  if (!model.appState) return;
...
function renderTranscriptHeader(refs: DomRefs, model: UiModel): void {
  if (!model.appState) return;
...
function isApiKeyReady(refs: DomRefs, model: UiModel): boolean {
