...
namespace TranscriptRender {
  ...
  export function collectSettings(refs: TranscriptDom.DomRefs): FrontendSettings {
    return {
  ...
  function renderToggles(refs: TranscriptDom.DomRefs, model: UiModel): void {
    if (!model.appState) return;
